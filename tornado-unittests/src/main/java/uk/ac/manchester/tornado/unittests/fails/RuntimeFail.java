...
public class RuntimeFail extends TornadoTestBase {
    ...
    void test01() {
        assertThrows(TornadoTaskRuntimeException.class, () -> {
            ...
            TaskGraph taskGraph = new TaskGraph("s0").transferToDevice(DataTransferMode.FIRST_EXECUTION, x, y).task("t0", RuntimeFail::vectorAdd, x, y, z).task("t0", RuntimeFail::square, z)
            ...
            try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(immutableTaskGraph)) {
                ...
                executionPlan.execute();   // <-- expected to throw TornadoTaskRuntimeException
            }
        });
    }
