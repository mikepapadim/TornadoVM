...
public class TestConcat extends TornadoTestBase {
    ...
    public void testByteArrayConcat() {
        ...
        for (int i = 0; i < a.getSize(); i++) {
            assertEquals(100, c.get(i), 0.0f, "Mismatch in first part of c");
        }
        for (int i = 0; i < b.getSize(); i++) {
            assertEquals(5, c.get(a.getSize() + i), 0.0f, "Mismatch in second part of c");
        }

        for (int i = 0; i < e.getSize(); i++) {
            assertEquals(12, c.get(a.getSize() + b.getSize() + i), 0.0f, "Mismatch in third part of c");
        }
    }
