...
public class TestSlice extends TornadoTestBase {
    ...
    public void testDoubleArraySlice() {
        ...
        for (int i = 0; i < slice.getSize(); i++) {
            assertEquals(5.0d, slice.get(i), 0.0f, "Mismatch in second part of slice");
        }
    }
    ...
    public void testByteArraySlice() {
        ...
        for (int i = 0; i < slice.getSize(); i++) {
            assertEquals(5.0, slice.get(i), 0.0f, "Mismatch in second part of slice");
        }
    }
    ...
    public void testHalfFloatArraySlice() {
        ...
        for (int i = 0; i < slice.getSize(); i++) {
            assertEquals(5.0d, slice.get(i).getFloat32(), 0.0f, "Mismatch in second part of slice");
        }
